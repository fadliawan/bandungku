...
*/
	 ...
	 */
	$config['site_title']		   = "menurutmu.com";
	
	/**
	 * Admin Email, admin@example.com
	 */
	$config['admin_email']		   = "admin@menurutmu.com";
	 ...
	 * id not required.
	 **/
	$config['columns']             = array('first_name', 'last_name', 'address', 'hopes', 'avatar', 'fb_profile', 'twitter_name', 'comments_posted');
